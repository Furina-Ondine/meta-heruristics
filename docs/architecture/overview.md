...
按任务寻找公共入口时使用 [API Overview](../api/overview.md)，参数、异常、所有权和成员生命周期以 XML 注释生成的 [API Reference](../reference/index.md) 为准。可运行示例见 [`examples/Metaheuristics.Examples/Program.cs`](../../examples/Metaheuristics.Examples/Program.cs)。
